...
{
    public UpdateProductValidator(ILocalizationService localization)
    {
        RuleFor(x => x.Name)
        ...
        RuleFor(x => x.UpdatedAt)
            .NotEmpty().WithMessage(localization.GetString("UpdatedAtRequired"))
            .Must(BeAValidDate).WithMessage(localization.GetString("UpdatedAtInvalid"));
    }
